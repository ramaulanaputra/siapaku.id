  ...
  return (
    <>
      ...
      <button
        ...
        className="inline-flex items-center gap-2 glass rounded-full px-6 py-3 text-white/80 hover:text-white hover:bg-white/10 transition-all duration-300 group disabled:opacity-50"
      >
        ...
        {showModal && (
          ...
          >
            ...
            >
              ...
              <button
                onClick={() => setShowModal(false)}
                className="absolute top-4 right-4 text-white/40 hover:text-white transition-colors w-8 h-8 flex items-center justify-center rounded-full hover:bg-white/10"
              >
                ✕
              </button>
              ...
              {/* Preview */}
              {isGenerating ? (
                <div className="aspect-[9/16] rounded-2xl bg-white/5 flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-12 h-12 border-3 border-white/10 border-t-purple-500 rounded-full animate-spin mx-auto mb-3" />
                    <p className="text-white/40 text-sm">Generating story...</p>
                  </div>
                </div>
              ) : storyDataUrl ? (
              ...
              {!isGenerating && storyDataUrl && (
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 glass rounded-xl py-3 text-white/80 hover:text-white hover:bg-white/10 transition-all text-sm font-medium flex items-center justify-center gap-2"
                  >
